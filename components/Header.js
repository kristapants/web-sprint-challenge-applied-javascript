...
const header = Header() //declaring a variable to represent the result of the function
headerContainer.append(header) //appending the variable to the desired element
